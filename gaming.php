...
<div class='row'>");
$page=$_GET['page'];
echo("<div id='part2'><h1>Gaming</h1><hr/>");
$sql1="select * from TBL_NAME where Category='Gaming'";
$result1=mysqli_query($con,$sql1);
$count=mysqli_num_rows($result1);
if($count!=0)
{
$total=ceil($count/3);
$sql="select * from TBL_NAME where Category='Gaming' ORDER BY Id DESC LIMIT $start_from,3";
...
$Id=$row['Id'];
 echo("<div class='col s4'>
    <div class='card small'>
            ...
            <a style='float:right;' class='dropdown-button btn' href='#' data-activates='dropdown-gaming$Id'>Share</a>

  <!-- Dropdown Structure -->
  <ul id='dropdown-gaming$Id' class='dropdown-content'>
...
for ($i=1; $i<=$total; $i++) { 
            echo "<li class='waves-effect'><a href='gaming.php?page=".$i."'>".$i."</a><li>"; 
};
echo("</ul></div>");
}
else
