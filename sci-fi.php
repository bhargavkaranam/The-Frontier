...
<div class='row'>");
$page=$_GET['page'];
echo("<div id='part2'><h1>Sci Fi</h1><hr/>");
$sql1="select * from TBL_NAME where Category='SciFi'";
$result1=mysqli_query($con,$sql1);
$count=mysqli_num_rows($result1);
if($count!=0)
{
$total=ceil($count/3);
$sql="select * from TBL_NAME where Category='SciFi' ORDER BY Id DESC LIMIT $start_from,3";
...
$Id=$row['Id'];
 echo("<div class='col s4'>
    <div class='card small'>
            ...
            <a style='float:right;' class='dropdown-button btn' href='#' data-activates='dropdown-guides$Id'>Share</a>

  <!-- Dropdown Structure -->
  <ul id='dropdown-guides$Id' class='dropdown-content'>
...
for ($i=1; $i<=$total; $i++) { 
            echo "<li class='waves-effect'><a href='automobile.php?page=".$i."'>".$i."</a><li>"; 
};
echo("</ul>");
echo("</div>");
}
...
<div class="fb-page" data-href="https://www.facebook.com/TheFrontier.in" data-width="250" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/TheFrontier.in"><a href="https://www.facebook.com/TheFrontier.in">VecTech</a></blockquote></div></div>
          ...
          <div class="left">
          <a href="tech-news.php" style="font-size:18">Tech News</a>
          <br/><a href="gadgets.php" style="font-size:18">Gadgets</a>
          <br/><a href="guides.php" style="font-size:18">Guides</a>
          <br/><a href="gaming.php" style="font-size:18">Gaming</a>
          <br/><a href="analysis.php" style="font-size:18">Analysis</a>
          ...
          <br/><a style="font-size:18">Advertise with Us</a>
          <br/><a href="about.php#contact" style="font-size:18">Contact Us</a>
          </div>
          </div>
          <div class="col s2">
          <h3 style="color:#FFFFFF;margin:0;font-size:25px;float:left;">Connect with Us</h3>
          <div class="left">
          <img style="margin-right:10px;" src='images/Facebook.png' height="20"><a href='http://www.facebook.com/vectech' style="font-size:18">Facebook</a>
          <br/> <img style="margin-right:10px;" src='images/Google+.png' height="20"><a style="font-size:18px;">Google Plus</a>
          <br/> <img style="margin-right:10px;" src='images/Twitter.png' height="20"><a style="font-size:18px;">Twitter</a>
          <br/> <img style="margin-right:10px;" src='images/Flipboard.png' height="20"><a style="font-size:18px;">Flipboard</a>
          </div>
          </div>
          <div class="col s2">
